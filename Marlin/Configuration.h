...
#define STRING_CONFIG_H_AUTHOR "(Jeremy Gold)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Orac"
...
// E = (80 / 83) * 6525 = 6289
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 87.147, 87.147, 1066.67, 6289 }
