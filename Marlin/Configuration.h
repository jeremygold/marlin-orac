...
#define STRING_CONFIG_H_AUTHOR "(Jeremy Gold, Bringup)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Orac the 3D Printer"
 ...
 *   998 5: Dummy Table that ALWAYS reads 25°C or the temperature defined below.
...
#define X_MIN_POS -30 // Avoid Bulldog Clip - Needed until I work out a better bed solution
#define Y_MIN_POS 0
#define Z_MIN_POS 0
